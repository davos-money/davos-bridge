...
async function main() {
    ...
    // External
    let {_symbolEthereum, _nameEthereum} = require(`./bridge.config.json`);
    ...
    let davosBridge = await upgrades.deployProxy(this.DavosBridge, [deployer.address, _symbolEthereum, _nameEthereum], {initializer: "initialize", nonce: _nonce}); _nonce += 1;
